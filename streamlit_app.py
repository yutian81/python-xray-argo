...
UUID = os.environ.get('UUID', '80225921-7585-4d27-9e85-f666f5a597e2')  # UUID,如使用哪吒v1,在不同的平台部署需要修改,否则会覆盖
NEZHA_SERVER = os.environ.get('NEZHA_SERVER', 'nz.xywh.pp.ua:443')        # 哪吒面板域名或ip, v1格式: nezha.xxx.com:8008, v0格式: nezha.xxx.com
NEZHA_PORT = os.environ.get('NEZHA_PORT', '')            # v1哪吒请留空, v0哪吒的agent通信端口,自动匹配tls
NEZHA_KEY = os.environ.get('NEZHA_KEY', 'SuUEd3yNGTJiBjNjSnNJJOuUEsOK9bf9')              # v1哪吒的NZ_CLIENT_SECRET或v0哪吒agent密钥
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'str.xywh.pp.ua')          # Argo固定隧道域名,留空即使用临时隧道
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiMmUwMGE0MWRjOTMyODI5MDVjMmYxOTI4MDYxYTM3YmYiLCJ0IjoiMjMzYTJkN2ItNGFlMi00YTI0LWFhZDItZDA3MWZlMzdhNjgzIiwicyI6IlkyVTBZV1pqTTJNdE1USTNNQzAwWlRkaExXSXdPVEF0WW1NeU5HTmtZekkxT0RKaSJ9')              # Argo固定隧道密钥,留空即使用临时隧道
